  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-full" id="sidenav-collapse-main">
      <ul class="navbar-nav">
				...
				<?php }else if($this->session->userdata('roles') == "user") {?>
					<li class="nav-item">
						<a href="<?php echo base_url('user') ?>" class="nav-link <?php echo (isset($profile)) ? $profile : '' ?>" href="./pages/profile.html">
							<div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
								<i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
							</div>
							<span class="nav-link-text ms-1">Profile</span>
					...
					<li class="nav-item">
						<a href="<?php echo base_url('user/transaction') ?>" class="nav-link <?php echo (isset($transaction)) ? $transaction : '' ?>" href="./pages/billing.html">
							<div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
								<i class="ni ni-credit-card text-success text-sm opacity-10"></i>
							</div>
							<span class="nav-link-text ms-1">Transaction</span>
