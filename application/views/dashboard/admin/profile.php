    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo base_url('admin/update_profile/' . $profiles['id']); ?>" method="post" enctype="multipart/form-data">
					...
					<?php if($profiles['roles'] == 'admin'){ ?>
						<div class="mb-3 form-group">
							<label for="username">username:</label>
							<input class="form-control" value="<?php echo $profiles['username']; ?>" type="text" name="username"
								id="username" required>
						</div>
	
						<div class="mb-3 form-group">
							<label for="email">email:</label>
							<input class="form-control" value="<?php echo $profiles['email']; ?>" type="email" name="email"
								id="email" required>
						</div>
						<div class="mb-3 form-group">
							<label for="Phone">Phone:</label>
							<input class="form-control" value="<?php echo $profiles['phone']; ?>" type="number" name="phone"
								id="Phone" required>
						</div>
